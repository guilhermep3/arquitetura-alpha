...
let projectsHomeJson = [
   {id:1, name:'Arrayanes House', type:'Arquitetura Moderna', img:'assets/images/projects/arrayanes-house.jpg', local:'Equador - Puembo', year:'2021', size:'1240m²', colors:['#FFFAF0','#c7bbaa','#7e786e','#dbc599','#201f1c']},
   {id:2, name:'Brio House', type:'Arquitetura Moderna', img:'assets/images/projects/brio-house.jpg', local:'Brasil - Rio de Janeiro', year:'2023', size:'900m²', colors:['#3F322B','#c7bbaa','#7e786e','#90a9ca','#201f1c']},
   {id:3, name:'Dual House', type:'Arquitetura Minimalista', img:'assets/images/projects/dual-house.jpg', local:'Argentina - Buenos Aires', year:'2023', size:'710m²', colors:['#94715f','#65855d','#dad2c6','#3a3131','#473019']},
   {id:4, name:'Eclipse House', type:'Arquitetura Moderna', img:'assets/images/projects/eclipse-house.jpg', local:'Equador - Cumbaya', year:'2023', size:'1300m²', colors:['#c46d3c','#a89f92','#2e200c','#8a968f','#222338']},
   {id:5, name:'Fusion House', type:'Arquitetura Tropical', img:'assets/images/projects/fusion-house.jpg', local:'Brasil - Rio de Janeiro', year:'2024', size:'1500m²', colors:['#a89f92','#c7bbaa','#a89f92','#dbc599','#3F322B']},
   {id:6, name:'Emperadora House', type:'Arquitetura Contemporânea', img:'assets/images/projects/emperadora-house.jpg', local:'Brasil - São Paulo', year:'2022', size:'855m²', colors:['#65855d','#3a3131','#7e786e','#dbc599','#201f1c']},
   {id:7, name:'Orizzonte House', type:'Arquitetura Minimalista', img:'assets/images/projects/orizzonte-house.jpg', local:'Brasil - Rio de Janeiro', year:'2022', size:'1000m²', colors:['#c46d3c','#c7bbaa','#222338','#65855d','#dad2c6']},
   {id:8, name:'Zenith House', type:'Arquitetura Moderna', img:'assets/images/projects/zenith-house.jpg', local:'Brasil - São Paulo', year:'2022', size:'1000m²', colors:['#FFFAF0','#201f1c','#7e786e','#dad2c6','#222338']}
]
